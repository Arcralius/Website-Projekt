                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="changepasswordprocess.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="cfm_new_password">Confirm New Password</label>
                                        <input type="password" class="form-control" id="cfm_new_password" placeholder="Confirm New Password" name="cfm_new_password">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
