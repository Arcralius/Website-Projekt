...
<body>
    ...
    <div class="container-xl px-4 mt-4">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <p class="modal-title" id="exampleModalLabel">Update Card</p>
        ...
        <!-- Delete Card -->
        <div class="modal fade" id="deletecard" title="deletecard" tabindex="-1" aria-labelledby="deletecard" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        {
            global $errorMsg, $success, $paymentID, $fullName, $cardNo, $cvv, $expiration, $address;
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        echo '<tr>';
                            echo '<td>';
                                ...
                                echo '<span class = "label label-default">' . $cardNo . '</span>';
                            echo '</td>';
